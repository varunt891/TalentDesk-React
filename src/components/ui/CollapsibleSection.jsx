 ...
 */
export default function CollapsibleSection({ title, subtitle, count, tone = 'neutral', children, loading, defaultOpen = true, className = '' }) {
  const [open, setOpen] = useState(defaultOpen)
  return (
    <Card className={className}>
      <button type="button" onClick={() => setOpen(o => !o)} className="focus-ring w-full flex items-center justify-between gap-3 mb-3.5 text-left rounded-[var(--radius-sm)] group/collapsible">
